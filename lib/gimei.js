...
class Name extends Japanese {
    constructor(kanji, hiragana, katakana, gender) {
        super(kanji, hiragana, katakana);
        this.gender = gender;
    }
...
class Gimei {
    static name() {
        return new FullName(sample([MALE, FEMALE]));
    }

    static male() {
        return new FullName(MALE);
    }

    static female() {
        return new FullName(FEMALE);
    }
